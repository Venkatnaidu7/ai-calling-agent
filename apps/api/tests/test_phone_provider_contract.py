...
from app.api.phone_numbers import _provider, to_out
...
def test_plivo_attach_schema_requires_e164():
    payload = PlivoNumberAttach(phone_number="+919876543210", provider="plivo")
    assert payload.phone_number == "+919876543210"
    assert payload.provider == "plivo"

    with pytest.raises(ValueError):
        PlivoNumberAttach(phone_number="919876543210", provider="plivo")
