...
for r in [auth_router,agents_router,phone_numbers_router,voice_router,product_router,calls_router,analytics_router,billing_router]: app.include_router(r,prefix='/api/v1')
@app.get('/health')
